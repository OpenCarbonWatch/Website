    ...
    <div ref="root">
        ...
        >
            <div v-bind="rootProps">
                ...
                <input class="form-control autocomplete-input" :id="id" :name="id"
                       ref="input"
                       v-bind="inputProps"
                       @input="handleInput"
                ...
                >
                    <template v-for="(result, index) in results">
                        <slot name="result" :result="result" :props="resultProps[index]">
                            <li class="autocomplete-result" :key="resultProps[index].id" v-bind="resultProps[index]">
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                resultListId: uniqueId('autocomplete-result-list-'),
                results: [],
                selectedIndex: -1,
                expanded: false,
                loading: false,
